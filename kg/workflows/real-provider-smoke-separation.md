...
type: workflow
date: 2026-04-26
validated_by: [BUI-118, BUI-119, BUI-129]
tags: [provider, smoke, ci, codex, validation]
---
...
8. 문서와 script를 함께 갱신한다.
   `docs/smoke-testing.md`의 실행 명령, 전제 조건, 실패 원인 표가 실제 script와 맞아야 한다.
9. Reviewer handoff에는 기본 테스트 결과, opt-in skip 동작, real smoke 실행 방법, 실패 축 변경 여부를 포함한다.
